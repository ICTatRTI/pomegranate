...
_db = {
  replicateBothWays: function() {
    ...
    PouchDB.replicate(P.config.database_name, P.config.remote_url, {
      continuous: true
    });
    return PouchDB.replicate(P.config.remote_url, P.config.database_name, {
      continuous: true
    });
  },
...
P.boot = function() {
  ...
  U.log("Starting DB");
  try {
    P.db = new PouchDB(P.config.database_name, {
      adapter: "websql"
    });
