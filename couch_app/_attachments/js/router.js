...
SendView = (function(_super) {
  ...
  SendView.prototype.render = function() {
    return this.$el.html("        <h2>Numbers to send text/SMS to <span id='number_phone_numbers'></span></h2>        <textarea id='numbers' style='height:300px'></textarea>        <h2>Message to send <span id='chars_left'></span></h2>        <textarea id='text' style=''></textarea>        <br/>        <button>Send</button>      </div>    ");
  };
